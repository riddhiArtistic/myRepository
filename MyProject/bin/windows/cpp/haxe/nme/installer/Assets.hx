...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/baby.png", "assets/baby.png");
			resourceTypes.set ("assets/baby.png", "image");
			resourceNames.set ("assets/babyCry.png", "assets/babyCry.png");
			resourceTypes.set ("assets/babyCry.png", "image");
			resourceNames.set ("assets/babyDance.png", "assets/babyDance.png");
			resourceTypes.set ("assets/babyDance.png", "image");
			resourceNames.set ("assets/babyIdea.png", "assets/babyIdea.png");
			resourceTypes.set ("assets/babyIdea.png", "image");
			resourceNames.set ("assets/babyWonder.png", "assets/babyWonder.png");
			...
			resourceNames.set ("assets/movingBG.png", "assets/movingBG.png");
			resourceTypes.set ("assets/movingBG.png", "image");
			resourceNames.set ("assets/movingBG32.png", "assets/movingBG32.png");
