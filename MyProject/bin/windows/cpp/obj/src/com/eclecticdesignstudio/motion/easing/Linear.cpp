...
#include <com/eclecticdesignstudio/motion/easing/Linear.h>
#endif
#ifndef INCLUDED_com_eclecticdesignstudio_motion_easing_LinearEaseNone
#include <com/eclecticdesignstudio/motion/easing/LinearEaseNone.h>
#endif
namespace com{
...
::com::eclecticdesignstudio::motion::easing::IEasing Linear_obj::easeNone;

::com::eclecticdesignstudio::motion::easing::IEasing Linear_obj::get_easeNone( ){
	HX_STACK_PUSH("Linear::get_easeNone","com/eclecticdesignstudio/motion/easing/Linear.hx",17);
	HX_STACK_LINE(17)
	return ::com::eclecticdesignstudio::motion::easing::LinearEaseNone_obj::__new();
}
...
Dynamic Linear_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	switch(inName.length) {
	case 8:
		if (HX_FIELD_EQ(inName,"easeNone") ) { easeNone=inValue.Cast< ::com::eclecticdesignstudio::motion::easing::IEasing >(); return inValue; }
	}
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.Linear"), hx::TCanCast< Linear_obj> ,sStaticFields,sMemberFields,
