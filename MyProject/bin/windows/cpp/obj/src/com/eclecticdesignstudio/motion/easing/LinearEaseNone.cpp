...
{
HX_STACK_PUSH("LinearEaseNone::new","com/eclecticdesignstudio/motion/easing/Linear.hx",30);
{
}
;
	return null();
...
Float LinearEaseNone_obj::ease( Float t,Float b,Float c,Float d){
	HX_STACK_PUSH("LinearEaseNone::ease","com/eclecticdesignstudio/motion/easing/Linear.hx",44);
	HX_STACK_THIS(this);
	HX_STACK_ARG(t,"t");
	HX_STACK_ARG(b,"b");
	HX_STACK_ARG(c,"c");
...
Float LinearEaseNone_obj::calculate( Float k){
	HX_STACK_PUSH("LinearEaseNone::calculate","com/eclecticdesignstudio/motion/easing/Linear.hx",37);
	HX_STACK_THIS(this);
	HX_STACK_ARG(k,"k");
	HX_STACK_LINE(37)
	return k;
...
{
	Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.eclecticdesignstudio.motion.easing.LinearEaseNone"), hx::TCanCast< LinearEaseNone_obj> ,sStaticFields,sMemberFields,
