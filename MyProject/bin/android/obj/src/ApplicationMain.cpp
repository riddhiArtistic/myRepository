...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING("Riddhi"),HX_CSTRING("MyProject"),HX_CSTRING("com.velVetArts.MyProject"),HX_CSTRING("1.0.0"));
		...
		Void run(){
			HX_STACK_PUSH("*::_Function_1_1","ApplicationMain.hx",40);
			{
				...
				HX_STACK_LINE(49)
				{
					...
					Array< ::String > _g1 = ::Type_obj::getClassFields(hx::ClassOf< ::Jump >());		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(49)
					while(((_g < _g1->length))){
						HX_STACK_LINE(49)
				...
				if ((hasMain)){
					HX_STACK_LINE(59)
					::Reflect_obj::callMethod(hx::ClassOf< ::Jump >(),::Reflect_obj::field(hx::ClassOf< ::Jump >(),HX_CSTRING("main")),Dynamic( Array_obj<Dynamic>::__new()));
				}
				else{
					HX_STACK_LINE(64)
					::Jump instance = ::Type_obj::createInstance(hx::ClassOf< ::Jump >(),Dynamic( Array_obj<Dynamic>::__new()));		HX_STACK_VAR(instance,"instance");
					HX_STACK_LINE(66)
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)60,(int)10092492,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::FULLSCREEN))) | int((int)0))) | int((int)0)),HX_CSTRING("MyProject"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(107)
	if (((inName == HX_CSTRING("assets/baby.png")))){
		HX_STACK_LINE(108)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/baby.png"),null());
	}
	HX_STACK_LINE(114)
	if (((inName == HX_CSTRING("assets/babyCry.png")))){
		HX_STACK_LINE(115)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/babyCry.png"),null());
	}
	HX_STACK_LINE(121)
	if (((inName == HX_CSTRING("assets/babyDance.png")))){
		HX_STACK_LINE(122)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/babyDance.png"),null());
	}
	HX_STACK_LINE(128)
	if (((inName == HX_CSTRING("assets/babyIdea.png")))){
		HX_STACK_LINE(129)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/babyIdea.png"),null());
	}
	HX_STACK_LINE(135)
	if (((inName == HX_CSTRING("assets/babyWonder.png")))){
		HX_STACK_LINE(136)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/babyWonder.png"),null());
	}
	HX_STACK_LINE(142)
	...
	HX_STACK_LINE(149)
	if (((inName == HX_CSTRING("assets/movingBG.png")))){
		HX_STACK_LINE(150)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/movingBG.png"),null());
	}
	HX_STACK_LINE(156)
	if (((inName == HX_CSTRING("assets/movingBG32.png")))){
		HX_STACK_LINE(157)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("assets/movingBG32.png"),null());
	}
	HX_STACK_LINE(164)
	return null();
}
