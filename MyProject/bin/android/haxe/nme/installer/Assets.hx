...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/baby.png", "assets_baby_png");
			resourceTypes.set ("assets/baby.png", "image");
			resourceNames.set ("assets/babyCry.png", "assets_babycry_png");
			resourceTypes.set ("assets/babyCry.png", "image");
			resourceNames.set ("assets/babyDance.png", "assets_babydance_png");
			resourceTypes.set ("assets/babyDance.png", "image");
			resourceNames.set ("assets/babyIdea.png", "assets_babyidea_png");
			resourceTypes.set ("assets/babyIdea.png", "image");
			resourceNames.set ("assets/babyWonder.png", "assets_babywonder_png");
			resourceTypes.set ("assets/babyWonder.png", "image");
			resourceNames.set ("assets/BackGround.png", "assets_background_png");
			resourceTypes.set ("assets/BackGround.png", "image");
			resourceNames.set ("assets/movingBG.png", "assets_movingbg_png");
			resourceTypes.set ("assets/movingBG.png", "image");
			resourceNames.set ("assets/movingBG32.png", "assets_movingbg32_png");
			resourceTypes.set ("assets/movingBG32.png", "image");
