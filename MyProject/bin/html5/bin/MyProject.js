...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("assets/baby.png",loader);
	ApplicationMain.total++;
	var loader1 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/babyCry.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/babyDance.png",loader2);
	ApplicationMain.total++;
	var loader3 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/babyIdea.png",loader3);
	ApplicationMain.total++;
	var loader4 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/babyWonder.png",loader4);
	ApplicationMain.total++;
	var loader5 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/BackGround.png",loader5);
	ApplicationMain.total++;
	var loader6 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/movingBG.png",loader6);
	ApplicationMain.total++;
	var loader7 = new browser.display.Loader();
	ApplicationMain.loaders.set("assets/movingBG32.png",loader7);
	ApplicationMain.total++;
...
ApplicationMain.getAsset = function(inName) {
	if(inName == "assets/baby.png") return nme.installer.Assets.getBitmapData("assets/baby.png");
	if(inName == "assets/babyCry.png") return nme.installer.Assets.getBitmapData("assets/babyCry.png");
	if(inName == "assets/babyDance.png") return nme.installer.Assets.getBitmapData("assets/babyDance.png");
	if(inName == "assets/babyIdea.png") return nme.installer.Assets.getBitmapData("assets/babyIdea.png");
	if(inName == "assets/babyWonder.png") return nme.installer.Assets.getBitmapData("assets/babyWonder.png");
	if(inName == "assets/BackGround.png") return nme.installer.Assets.getBitmapData("assets/BackGround.png");
	if(inName == "assets/movingBG.png") return nme.installer.Assets.getBitmapData("assets/movingBG.png");
	if(inName == "assets/movingBG32.png") return nme.installer.Assets.getBitmapData("assets/movingBG32.png");
	return null;
}
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	} else Reflect.field(Jump,"main").apply(Jump,[]);
}
var browser = {}
browser.events = {}
...
$hxClasses["BackGroundImg"] = BackGroundImg;
BackGroundImg.__name__ = ["BackGroundImg"];
BackGroundImg.__super__ = browser.display.Sprite;
BackGroundImg.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		this.myBG = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/BackGround.png"));
		this.myBG.alpha = 1;
		this.myBG.set_x((this.get_stage().get_stageWidth() - this.myBG.get_width()) / 2);
		this.myBG.set_y((this.get_stage().get_stageHeight() - this.myBG.get_height()) / 2);
		this.addChild(this.myBG);
	}
	,myBG: null
	,__class__: BackGroundImg
});
...
Character.__super__ = browser.display.Sprite;
Character.prototype = $extend(browser.display.Sprite.prototype,{
	updateImg: function(eve) {
		this.myBitmap.alpha = 1;
		var _g = this.container;
		_g.set_rotation(_g.get_rotation() + 5.0);
		if(this.container.get_x() >= this.get_stage().get_stageWidth() - 20) this.container.set_x(20); else {
			var _g = this.container;
			_g.set_x(_g.get_x() + 1);
		}
	}
	,init: function(e) {
		this.myBitmap = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/baby.png"));
		this.container = new browser.display.Sprite();
		this.container.addChild(this.myBitmap);
		this.container.set_x(20);
		this.container.set_y(this.get_stage().get_stageHeight() / 2);
		this.myBitmap.alpha = 0;
		this.myBitmap.set_x(-this.myBitmap.get_width() / 2);
		this.myBitmap.set_y(-this.myBitmap.get_height() / 2);
		this.container.buttonMode = true;
		this.addChild(this.container);
		this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.updateImg));
	}
	,container: null
	,myBitmap: null
	,__class__: Character
...
Jump.main = function() {
	...
	stage.scaleMode = browser.display.StageScaleMode.NO_SCALE;
	stage.align = browser.display.StageAlign.TOP_LEFT;
	nme.Lib.get_current().addChild(new Jump());
}
Jump.__super__ = browser.display.Sprite;
Jump.prototype = $extend(browser.display.Sprite.prototype,{
	renderScrollingBG: function(event) {
		this.movingBG.set_scrollRect(new browser.geom.Rectangle(this.scrollIndex,0,640 + this.scrollIndex,480));
		if(this.scrollIndex > 640) this.scrollIndex = 0; else this.scrollIndex++;
	}
	,init: function(e) {
		this.myBGImg = new BackGroundImg();
		this.movingBG = new MovingBGImg();
		this.myCharacter = new Character();
		this.addChild(this.myBGImg);
		this.scrollIndex = 0;
		this.addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.renderScrollingBG));
...
var MovingBGImg = function() {
	browser.display.Sprite.call(this);
	this.addEventListener(browser.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["MovingBGImg"] = MovingBGImg;
MovingBGImg.__name__ = ["MovingBGImg"];
MovingBGImg.__super__ = browser.display.Sprite;
MovingBGImg.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		this.myBG = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("assets/movingBG.png"));
		this.myBG.alpha = 1;
		this.myBG.set_x((this.get_stage().get_stageWidth() - this.myBG.get_width()) / 2);
		this.myBG.set_y((this.get_stage().get_stageHeight() - this.myBG.get_height()) / 2);
		this.addChild(this.myBG);
...
com.eclecticdesignstudio.motion.easing.Bounce = function() { }
$hxClasses["com.eclecticdesignstudio.motion.easing.Bounce"] = com.eclecticdesignstudio.motion.easing.Bounce;
com.eclecticdesignstudio.motion.easing.Bounce.__name__ = ["com","eclecticdesignstudio","motion","easing","Bounce"];
com.eclecticdesignstudio.motion.easing.Bounce.__properties__ = {get_easeOut:"getEaseOut",get_easeInOut:"getEaseInOut",get_easeIn:"getEaseIn"}
com.eclecticdesignstudio.motion.easing.Bounce.easeIn = null;
com.eclecticdesignstudio.motion.easing.Bounce.easeInOut = null;
com.eclecticdesignstudio.motion.easing.Bounce.easeOut = null;
com.eclecticdesignstudio.motion.easing.Bounce.getEaseIn = function() {
	return new com.eclecticdesignstudio.motion.easing.BounceEaseIn();
}
com.eclecticdesignstudio.motion.easing.Bounce.getEaseInOut = function() {
	return new com.eclecticdesignstudio.motion.easing.BounceEaseInOut();
}
com.eclecticdesignstudio.motion.easing.Bounce.getEaseOut = function() {
	return new com.eclecticdesignstudio.motion.easing.BounceEaseOut();
}
com.eclecticdesignstudio.motion.easing.BounceEaseIn = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.BounceEaseIn"] = com.eclecticdesignstudio.motion.easing.BounceEaseIn;
com.eclecticdesignstudio.motion.easing.BounceEaseIn.__name__ = ["com","eclecticdesignstudio","motion","easing","BounceEaseIn"];
com.eclecticdesignstudio.motion.easing.BounceEaseIn.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.BounceEaseIn._ease = function(t,b,c,d) {
	return c - com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(d - t,0,c,d) + b;
}
com.eclecticdesignstudio.motion.easing.BounceEaseIn.prototype = {
	ease: function(t,b,c,d) {
		return c - com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(d - t,0,c,d) + b;
	}
	,calculate: function(k) {
		return 1 - com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(1 - k,0,1,1);
	}
	,__class__: com.eclecticdesignstudio.motion.easing.BounceEaseIn
}
com.eclecticdesignstudio.motion.easing.BounceEaseInOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.BounceEaseInOut"] = com.eclecticdesignstudio.motion.easing.BounceEaseInOut;
com.eclecticdesignstudio.motion.easing.BounceEaseInOut.__name__ = ["com","eclecticdesignstudio","motion","easing","BounceEaseInOut"];
com.eclecticdesignstudio.motion.easing.BounceEaseInOut.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.BounceEaseInOut.prototype = {
	ease: function(t,b,c,d) {
		if(t < d / 2) return (c - com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(d - t * 2,0,c,d)) * .5 + b; else return com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(t * 2 - d,0,c,d) * .5 + c * .5 + b;
	}
	,calculate: function(k) {
		if(k < .5) return (1 - com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(1 - k * 2,0,1,1)) * .5; else return com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(k * 2 - 1,0,1,1) * .5 + .5;
	}
	,__class__: com.eclecticdesignstudio.motion.easing.BounceEaseInOut
}
com.eclecticdesignstudio.motion.easing.BounceEaseOut = function() {
};
$hxClasses["com.eclecticdesignstudio.motion.easing.BounceEaseOut"] = com.eclecticdesignstudio.motion.easing.BounceEaseOut;
com.eclecticdesignstudio.motion.easing.BounceEaseOut.__name__ = ["com","eclecticdesignstudio","motion","easing","BounceEaseOut"];
com.eclecticdesignstudio.motion.easing.BounceEaseOut.__interfaces__ = [com.eclecticdesignstudio.motion.easing.IEasing];
com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease = function(t,b,c,d) {
...
com.eclecticdesignstudio.motion.easing.BounceEaseOut.prototype = {
	ease: function(t,b,c,d) {
		return com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(t,b,c,d);
	}
	,calculate: function(k) {
		return com.eclecticdesignstudio.motion.easing.BounceEaseOut._ease(k,0,1,1);
	}
	,__class__: com.eclecticdesignstudio.motion.easing.BounceEaseOut
}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("assets/baby.png","assets/baby.png");
		nme.installer.Assets.resourceTypes.set("assets/baby.png","image");
		nme.installer.Assets.resourceNames.set("assets/babyCry.png","assets/babyCry.png");
		nme.installer.Assets.resourceTypes.set("assets/babyCry.png","image");
		nme.installer.Assets.resourceNames.set("assets/babyDance.png","assets/babyDance.png");
		nme.installer.Assets.resourceTypes.set("assets/babyDance.png","image");
		nme.installer.Assets.resourceNames.set("assets/babyIdea.png","assets/babyIdea.png");
		nme.installer.Assets.resourceTypes.set("assets/babyIdea.png","image");
		nme.installer.Assets.resourceNames.set("assets/babyWonder.png","assets/babyWonder.png");
		nme.installer.Assets.resourceTypes.set("assets/babyWonder.png","image");
		nme.installer.Assets.resourceNames.set("assets/BackGround.png","assets/BackGround.png");
		nme.installer.Assets.resourceTypes.set("assets/BackGround.png","image");
		nme.installer.Assets.resourceNames.set("assets/movingBG.png","assets/movingBG.png");
		nme.installer.Assets.resourceTypes.set("assets/movingBG.png","image");
		nme.installer.Assets.resourceNames.set("assets/movingBG32.png","assets/movingBG32.png");
		nme.installer.Assets.resourceTypes.set("assets/movingBG32.png","image");
...
nme.installer.Assets.getBitmapData = function(id,useCache) {
	...
	if(nme.installer.Assets.resourceNames.exists(id) && nme.installer.Assets.resourceTypes.exists(id) && nme.installer.Assets.resourceTypes.get(id).toLowerCase() == "image") {
		...
		} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 157, className : "nme.installer.Assets", methodName : "getBitmapData"});
	} else haxe.Log.trace("[nme.Assets] There is no BitmapData asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 163, className : "nme.installer.Assets", methodName : "getBitmapData"});
	return null;
}
nme.installer.Assets.getBytes = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no String or ByteArray asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 182, className : "nme.installer.Assets", methodName : "getBytes"});
	return null;
}
nme.installer.Assets.getFont = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Font asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 203, className : "nme.installer.Assets", methodName : "getFont"});
	return null;
}
nme.installer.Assets.getMovieClip = function(id) {
	...
	var symbolName = HxOverrides.substr(id,id.indexOf(":") + 1,null);
	if(nme.installer.Assets.libraryTypes.exists(libraryName)) {
	} else haxe.Log.trace("[nme.Assets] There is no asset library named \"" + libraryName + "\"",{ fileName : "Assets.hx", lineNumber : 255, className : "nme.installer.Assets", methodName : "getMovieClip"});
	return null;
}
...
nme.installer.Assets.getSound = function(id) {
	...
	haxe.Log.trace("[nme.Assets] There is no Sound asset with an ID of \"" + id + "\"",{ fileName : "Assets.hx", lineNumber : 291, className : "nme.installer.Assets", methodName : "getSound"});
	return null;
}
