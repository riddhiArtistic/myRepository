...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("assets/baby.png", NME_assets_baby_png);
			resourceTypes.set ("assets/baby.png", "image");
			resourceClasses.set ("assets/babyCry.png", NME_assets_babycry_png);
			resourceTypes.set ("assets/babyCry.png", "image");
			resourceClasses.set ("assets/babyDance.png", NME_assets_babydance_png);
			resourceTypes.set ("assets/babyDance.png", "image");
			resourceClasses.set ("assets/babyIdea.png", NME_assets_babyidea_png);
			resourceTypes.set ("assets/babyIdea.png", "image");
			resourceClasses.set ("assets/babyWonder.png", NME_assets_babywonder_png);
			...
			resourceClasses.set ("assets/movingBG.png", NME_assets_movingbg_png);
			resourceTypes.set ("assets/movingBG.png", "image");
			resourceClasses.set ("assets/movingBG32.png", NME_assets_movingbg32_png);
