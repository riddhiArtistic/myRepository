...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("img/baby.png",loader);
	ApplicationMain.total++;
	var loader1 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/candy.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/clouds1.png",loader2);
	ApplicationMain.total++;
	var loader3 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/clouds2.png",loader3);
	ApplicationMain.total++;
	var loader4 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/clouds3.png",loader4);
	ApplicationMain.total++;
	var loader5 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/movingBG.png",loader5);
	ApplicationMain.total++;
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader6.load(new browser.net.URLRequest(path));
		}
...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(com.velvetArts.v01.Main,"main") == null) {
		var mainDisplayObj = new com.velvetArts.v01.Main();
		if(js.Boot.__instanceof(mainDisplayObj,browser.display.DisplayObject)) nme.Lib.get_current().addChild(mainDisplayObj);
	} else Reflect.field(com.velvetArts.v01.Main,"main").apply(com.velvetArts.v01.Main,[]);
}
...
com.velvetArts = {}
com.velvetArts.v01 = {}
com.velvetArts.v01.Actor = function() {
	this.IsActive = false;
	browser.display.Sprite.call(this);
	this.actor = new browser.display.Sprite();
	this.actor.get_graphics().beginBitmapFill(nme.installer.Assets.getBitmapData("img/baby.png"),null,false,true);
	this.actor.get_graphics().drawRect(0,0,60,60);
	this.actor.set_x(-this.actor.get_width() / 2.0);
	this.actor.set_y(-this.actor.get_height() / 2.0);
	this.set_x(nme.Lib.get_current().get_stage().get_stageWidth() / 2.0);
	this.set_y(nme.Lib.get_current().get_stage().get_stageHeight() / 2.0);
	this.addChild(this.actor);
	this.jumpFlag = false;
	this.jumpBKW = false;
	this.jumpFWD = false;
};
$hxClasses["com.velvetArts.v01.Actor"] = com.velvetArts.v01.Actor;
com.velvetArts.v01.Actor.__name__ = ["com","velvetArts","v01","Actor"];
com.velvetArts.v01.Actor.__super__ = browser.display.Sprite;
com.velvetArts.v01.Actor.prototype = $extend(browser.display.Sprite.prototype,{
	stopMove: function(e) {
		this.jumpFlag = false;
		nme.Lib.get_current().get_stage().removeEventListener(browser.events.MouseEvent.MOUSE_MOVE,$bind(this,this.Move));
		nme.Lib.get_current().get_stage().removeEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.en_Move));
	}
	,Move: function(e) {
		if(30 < e.stageY && e.stageY < nme.Lib.get_current().get_stage().get_stageWidth() - 30) this.jumpFlag = true;
	}
	,en_Move: function(e) {
		nme.Lib.get_current().get_stage().addEventListener(browser.events.MouseEvent.MOUSE_MOVE,$bind(this,this.Move));
		nme.Lib.get_current().get_stage().addEventListener(browser.events.MouseEvent.MOUSE_UP,$bind(this,this.stopMove));
		e.updateAfterEvent();
	}
	,stopDragging: function(e) {
		this.jumpFlag = false;
		nme.Lib.get_current().get_stage().removeEventListener("touchEnd",$bind(this,this.stopDragging));
		nme.Lib.get_current().get_stage().removeEventListener("touchMove",$bind(this,this.jump));
	}
	,jump: function(e) {
		if(this.IsActive) {
			if(e.touchPointID == 0) {
	...
	,startDragging: function(e) {
		if(this.IsActive) {
			...
			nme.Lib.get_current().get_stage().addEventListener("touchEnd",$bind(this,this.stopDragging));
			nme.Lib.get_current().get_stage().addEventListener("touchMove",$bind(this,this.jump));
		}
	}
	,update: function() {
		if(this.IsActive) {
			nme.Lib.get_current().get_stage().addEventListener("touchBegin",$bind(this,this.startDragging));
			nme.Lib.get_current().get_stage().addEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.en_Move));
		}
	}
	,__class__: com.velvetArts.v01.Actor
});
com.velvetArts.v01.Candy = function(inX,inY) {
	this.framedelay = 0;
	browser.display.Sprite.call(this);
	this.set_x(inX);
	this.set_y(inY);
	this.actor = new browser.display.Sprite();
	this.actor.get_graphics().beginBitmapFill(nme.installer.Assets.getBitmapData("img/candy.png"));
	this.actor.get_graphics().drawRect(0,0,36,36);
	this.actor.set_x(-this.actor.get_width() / 2.0);
	this.actor.set_y(-this.actor.get_height() / 2.0);
	this.addChild(this.actor);
	this.set_width(36);
...
$hxClasses["com.velvetArts.v01.Candy"] = com.velvetArts.v01.Candy;
com.velvetArts.v01.Candy.__name__ = ["com","velvetArts","v01","Candy"];
com.velvetArts.v01.Candy.__super__ = browser.display.Sprite;
com.velvetArts.v01.Candy.prototype = $extend(browser.display.Sprite.prototype,{
	update: function() {
		if(this.get_x() > nme.Lib.get_current().get_stage().get_stageWidth()) this.set_x(0); else {
			var _g = this;
			_g.set_x(_g.get_x() + 1);
		}
		if(!this.get_visible()) {
			if(this.framedelay > 180) {
				this.set_visible(true);
				this.framedelay = 0;
			}
			this.framedelay++;
	...
	,__class__: com.velvetArts.v01.Candy
});
com.velvetArts.v01.Clouds = function(inX,inY) {
	browser.display.Sprite.call(this);
	this.set_x(inX);
	this.set_y(inY);
	this.frames = 1;
	this.cloud1 = new browser.display.Sprite();
	this.cloud2 = new browser.display.Sprite();
	this.cloud3 = new browser.display.Sprite();
	this.actor = new browser.display.Sprite();
	this.cloud1.get_graphics().beginBitmapFill(nme.installer.Assets.getBitmapData("img/clouds1.png"),null,false,true);
	this.cloud1.get_graphics().drawRect(0,0,70,20);
	this.cloud2.get_graphics().beginBitmapFill(nme.installer.Assets.getBitmapData("img/clouds2.png"),null,false,true);
	this.cloud2.get_graphics().drawRect(0,0,70,20);
	this.cloud3.get_graphics().beginBitmapFill(nme.installer.Assets.getBitmapData("img/clouds3.png"),null,false,true);
	this.cloud3.get_graphics().drawRect(0,0,70,20);
	this.actor = this.cloud1;
	this.actor.set_x(-this.actor.get_width() / 2.0);
	this.actor.set_y(-this.actor.get_height() / 2.0);
	this.addChild(this.actor);
};
$hxClasses["com.velvetArts.v01.Clouds"] = com.velvetArts.v01.Clouds;
com.velvetArts.v01.Clouds.__name__ = ["com","velvetArts","v01","Clouds"];
com.velvetArts.v01.Clouds.__super__ = browser.display.Sprite;
com.velvetArts.v01.Clouds.prototype = $extend(browser.display.Sprite.prototype,{
	update: function() {
		this.get_graphics().clear();
		if(this.frames > 60 && this.frames <= 120) {
			this.actor = this.cloud2;
			this.addChild(this.actor);
		} else if(this.frames > 120 && this.frames <= 180) {
			this.actor = this.cloud3;
			this.addChild(this.actor);
		} else {
			if(this.frames > 180) this.frames = 0;
			this.actor = this.cloud1;
			this.addChild(this.actor);
		}
		this.actor.set_x(-this.actor.get_width() / 2.0);
	...
	,__class__: com.velvetArts.v01.Clouds
});
com.velvetArts.v01.Game = function() {
	this.cloudHit = false;
	var _g = this;
	browser.display.Sprite.call(this);
	nme.Lib.get_current().get_stage().addChild(this);
	this.stgWidth = nme.Lib.get_current().get_stage().get_stageWidth();
	this.stgHeight = nme.Lib.get_current().get_stage().get_stageHeight();
	this.bgImg = new com.velvetArts.v01.MovingBG();
	this.addChild(this.bgImg);
	this.mCandies = [];
	var _g1 = 0;
	while(_g1 < 10) {
		var i = _g1++;
		var x_pos = Math.random() * this.stgWidth;
		var y_pos = Math.random() * this.stgHeight;
		this.mCandies[i] = new com.velvetArts.v01.Candy(x_pos,y_pos);
		this.addChild(this.mCandies[i]);
	}
	this.mClouds = [];
	var _g1 = 0;
	while(_g1 < 20) {
		...
		var x_pos = Math.random() * this.stgWidth;
		var y_pos = Math.random() * this.stgHeight;
		this.mClouds[i] = new com.velvetArts.v01.Clouds(x_pos,y_pos);
		this.addChild(this.mClouds[i]);
	}
	this.baby = new com.velvetArts.v01.Actor();
	this.addChild(this.baby);
	this.mScore = 0;
	this.topScore = 1000;
	this.states = new com.velvetArts.v01.GameStates();
	this.timer = new haxe.Timer(com.velvetArts.v01.Game.fps_data);
	this.timer.run = function() {
		_g.get_graphics().clear();
		_g.update();
	};
};
$hxClasses["com.velvetArts.v01.Game"] = com.velvetArts.v01.Game;
com.velvetArts.v01.Game.__name__ = ["com","velvetArts","v01","Game"];
com.velvetArts.v01.Game.__super__ = browser.display.Sprite;
com.velvetArts.v01.Game.prototype = $extend(browser.display.Sprite.prototype,{
	startTouchGame: function(e) {
	...
	,check_Collision: function() {
		...
		while(_g < 20) {
			var i = _g++;
			if(!this.cloudHit) {
				if(this.baby.hitTestObject(this.mClouds[i])) {
					this.cloudHit = true;
					this.baby.set_x(this.mClouds[i].get_x());
					this.baby.set_y(this.mClouds[i].get_y() - 25);
				}
			}
		}
		var _g = 0;
		while(_g < 10) {
			var i = _g++;
			if(this.mCandies[i].get_visible()) {
				if(this.baby.hitTestObject(this.mCandies[i])) {
					this.mScore += 10;
					this.mCandies[i].set_visible(false);
				}
			}
		}
	}
	,update: function() {
		var stgWidth = nme.Lib.get_current().get_stage().get_stageWidth();
		var stgHeight = nme.Lib.get_current().get_stage().get_stageHeight();
		this.bgImg.update();
		if(this.states.Active) {
			...
			while(_g < 10) {
				var i = _g++;
				this.mCandies[i].update();
			}
			if(this.baby.jumpFlag) {
				if(this.cloudHit) this.cloudHit = false;
				if(this.baby.get_y() > 0) {
					var _g = this.baby;
					_g.set_y(_g.get_y() - 2);
				}
			} else {
				...
				if(!this.cloudHit) {
					if(this.baby.get_x() > stgWidth) this.baby.set_x(0); else {
						var _g = this.baby;
		...
		} else if(this.states.Inactive) {
			this.baby.IsActive = false;
			var format = new browser.text.TextFormat();
			var terminalText;
			terminalText = new browser.text.TextField();
			format.font = "Arial";
			format.bold = true;
			format.color = 34850;
			format.size = 40;
			format.align = browser.text.TextFormatAlign.CENTER;
			terminalText.set_background(false);
			terminalText.set_defaultTextFormat(format);
			terminalText.set_x(10);
			terminalText.set_y(stgHeight / 2 - 25);
			terminalText.set_width(stgWidth - 20);
			terminalText.set_height(50);
			terminalText.set_text("YOU DIED! :(");
			this.addChild(terminalText);
		}
		var format = new browser.text.TextFormat();
		var mScoreText;
		mScoreText = new browser.text.TextField();
		format.font = "Arial";
		format.bold = true;
		format.color = 34850;
		format.size = 20;
		format.align = browser.text.TextFormatAlign.LEFT;
		mScoreText.set_x(10);
		mScoreText.set_y(20);
		mScoreText.set_width(200);
		mScoreText.set_height(30);
		mScoreText.set_defaultTextFormat(format);
		mScoreText.set_background(false);
		if(this.states.Active) mScoreText.set_text("Score: " + this.mScore); else if(this.states.Inactive) mScoreText.set_text("Your Score: " + this.mScore); else if(this.states.Play) {
			mScoreText.set_text("Click To Play!");
			mScoreText.addEventListener("touchTap",$bind(this,this.startTouchGame));
			mScoreText.addEventListener(browser.events.MouseEvent.MOUSE_DOWN,$bind(this,this.startClickGame));
		}
		this.addChild(mScoreText);
		var format1 = new browser.text.TextFormat();
		var mTopScoreText;
		mTopScoreText = new browser.text.TextField();
		format1.font = "Arial";
		format1.bold = true;
		format1.color = 34850;
		format1.size = 20;
		format1.align = browser.text.TextFormatAlign.RIGHT;
		mTopScoreText.set_x(stgWidth - 310);
		mTopScoreText.set_y(20);
		mTopScoreText.set_width(300);
		mTopScoreText.set_height(30);
		mTopScoreText.set_defaultTextFormat(format1);
		mTopScoreText.set_background(false);
		if(this.topScore < this.mScore) {
			if(this.states.Active) mTopScoreText.set_text("Top Score: " + this.mScore); else if(this.states.Inactive) mTopScoreText.set_text("Your Top Score: " + this.mScore);
		} else if(this.states.Active) mTopScoreText.set_text("Top Score: " + this.topScore); else if(this.states.Inactive) mTopScoreText.set_text("Your Top Score: " + this.topScore);
		this.addChild(mTopScoreText);
	}
	,__class__: com.velvetArts.v01.Game
});
com.velvetArts.v01.GameStates = function() {
	this.Active = false;
	this.Play = true;
	this.Inactive = false;
};
$hxClasses["com.velvetArts.v01.GameStates"] = com.velvetArts.v01.GameStates;
com.velvetArts.v01.GameStates.__name__ = ["com","velvetArts","v01","GameStates"];
com.velvetArts.v01.GameStates.prototype = {
	__class__: com.velvetArts.v01.GameStates
}
com.velvetArts.v01.Main = function() {
	browser.display.Sprite.call(this);
	this.addEventListener(browser.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["com.velvetArts.v01.Main"] = com.velvetArts.v01.Main;
com.velvetArts.v01.Main.__name__ = ["com","velvetArts","v01","Main"];
com.velvetArts.v01.Main.__super__ = browser.display.Sprite;
com.velvetArts.v01.Main.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		var game;
		game = new com.velvetArts.v01.Game();
	}
	,__class__: com.velvetArts.v01.Main
});
com.velvetArts.v01.MovingBG = function() {
	browser.display.Sprite.call(this);
	this.BG = new browser.display.Bitmap(nme.installer.Assets.getBitmapData("img/movingBG.png"));
	this.matriX = new browser.geom.Matrix();
	this.resize();
	nme.Lib.get_current().get_stage().addChild(this);
	this.addEventListener(browser.events.Event.RESIZE,$bind(this,this.resizeHandler));
};
$hxClasses["com.velvetArts.v01.MovingBG"] = com.velvetArts.v01.MovingBG;
com.velvetArts.v01.MovingBG.__name__ = ["com","velvetArts","v01","MovingBG"];
com.velvetArts.v01.MovingBG.__super__ = browser.display.Sprite;
com.velvetArts.v01.MovingBG.prototype = $extend(browser.display.Sprite.prototype,{
	update: function() {
	...
	,__class__: com.velvetArts.v01.MovingBG
});
var haxe = {}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		nme.installer.Assets.resourceNames.set("img/baby.png","img/baby.png");
		nme.installer.Assets.resourceTypes.set("img/baby.png","image");
		nme.installer.Assets.resourceNames.set("img/candy.png","img/candy.png");
		nme.installer.Assets.resourceTypes.set("img/candy.png","image");
		nme.installer.Assets.resourceNames.set("img/clouds1.png","img/clouds1.png");
		nme.installer.Assets.resourceTypes.set("img/clouds1.png","image");
		nme.installer.Assets.resourceNames.set("img/clouds2.png","img/clouds2.png");
		nme.installer.Assets.resourceTypes.set("img/clouds2.png","image");
		nme.installer.Assets.resourceNames.set("img/clouds3.png","img/clouds3.png");
		nme.installer.Assets.resourceTypes.set("img/clouds3.png","image");
		nme.installer.Assets.resourceNames.set("img/movingBG.png","img/movingBG.png");
		nme.installer.Assets.resourceTypes.set("img/movingBG.png","image");
...
com.velvetArts.v01.Game.fps_data = 1000 / 30;
