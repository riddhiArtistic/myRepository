...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("img/movingBG.png",loader1);
	ApplicationMain.total++;
	var loader2 = new browser.display.Loader();
	ApplicationMain.loaders.set("img/tiles.png",loader2);
	ApplicationMain.total++;
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader3.load(new browser.net.URLRequest(path));
		}
...
browser.ui.MultitouchInputMode = $hxClasses["browser.ui.MultitouchInputMode"] = { __ename__ : true, __constructs__ : ["NONE","TOUCH_POINT","GESTURE"] }
...
com.velvetArts = {}
com.velvetArts.v01 = {}
com.velvetArts.v01.Game = function(inTiles) {
	browser.display.Sprite.call(this);
	nme.Lib.get_current().addChild(this);
	this.renderList = new Array();
	this.characterList = new Array();
	this.tilesheet = inTiles;
	this.tilesheet.addTileRect(new browser.geom.Rectangle(5,0,640,480),new browser.geom.Point(320,240));
	this.tilesheet.addTileRect(new browser.geom.Rectangle(645,0,70,20),new browser.geom.Point(35,10));
	this.tilesheet.addTileRect(new browser.geom.Rectangle(715,0,70,20),new browser.geom.Point(35,10));
	this.tilesheet.addTileRect(new browser.geom.Rectangle(785,0,70,20),new browser.geom.Point(35,10));
	this.tilesheet.addTileRect(new browser.geom.Rectangle(855,0,60,60),new browser.geom.Point(30,30));
	nme.Lib.get_current().get_stage().addEventListener(browser.events.Event.ENTER_FRAME,$bind(this,this.frameEnter));
};
...
com.velvetArts.v01.Game.prototype = $extend(browser.display.Sprite.prototype,{
	frameEnter: function(e) {
		this.renderList = [];
		this.Render();
		this.tilesheet.drawTiles(this.get_graphics(),this.renderList);
	}
	,Render: function() {
		var stg_x = nme.Lib.get_current().get_stage().get_stageWidth() / 2;
		var stg_y = nme.Lib.get_current().get_stage().get_stageHeight() / 2;
		this.renderList = [stg_x,stg_y,0,stg_x,stg_y,4,stg_x - 10,stg_y - 30,2,stg_x - 50,stg_y - 60,3,stg_x - 90,stg_y - 40,1];
	}
...
com.velvetArts.v01.Main.prototype = $extend(browser.display.Sprite.prototype,{
	init: function(e) {
		this.tilesheet = new browser.display.Tilesheet(nme.installer.Assets.getBitmapData("img/tiles.png"));
		this.game = new com.velvetArts.v01.Game(this.tilesheet);
	}
...
nme.installer.Assets.initialize = function() {
	if(!nme.installer.Assets.initialized) {
		...
		nme.installer.Assets.resourceNames.set("img/tiles.png","img/tiles.png");
		nme.installer.Assets.resourceTypes.set("img/tiles.png","image");
